...
pt_weight_2 = r'\d\d{}\d{}{}'.format(comma, ss, kilo) ### case 43.5
...
### HEIGHT
pt_height_1 = r'\d\d\d{}cm'.format(ss)
pt_height_6 = r'(\d|){}\d\d(?!{}{})|\b(\d|){}\d{}m\b'.format(comma, ss, kilo, comma, ss)
pt_height_2 = r'(\d|)m{}\d\d(?!{}{})|\b(\d|)m{}\d\b'.format(ss, ss, kilo, ss)
pt_height_3 = r'(cao+){}\d(\sm|{})*{}[m|met]*|(met){}{}'.format(ss, comma,dd, ss,dd)
...
pt_height = r'({}|{}|{}|{}|{}|{})'.format(pt_height_1, \
            pt_height_6, pt_height_3, pt_height_4, pt_height_5, pt_height_2)
###-------------------------------------------
